...
namespace g923mac {
    struct ffb_config {
        ...
        static constexpr float center_stationary_force = 0.0f;
        // No centering when stationary (realistic truck behavior)
        ...
        static constexpr float terrain_detection_threshold = 0.08f;
        // Further lowered threshold for detecting surface changes
        static constexpr float terrain_minor_threshold = 0.02f;
        // Very sensitive threshold for minor bumps (curbs, potholes)
        static constexpr float terrain_major_threshold = 0.25f; // Threshold for major terrain changes
        static constexpr float terrain_impact_multiplier = 10.0f;
        // Increased force multiplier for sudden impacts (curbs)
